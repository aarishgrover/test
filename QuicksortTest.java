...
public class QuicksortTest
{
    ...
    */
    ...
    public void testSelect() {
      ...
      // median is 49
      int median=QS.randomisedselect(array1,0, array1.length-1, array1.length/2);
      System.out.println("median:"+ QS.randomisedselect(array1,0, array1.length-1, array1.length/2));
   ...
   public void testQS1Timing()
   {
     ...
     int[] array2 = QS.populate(1000000);
      ...
      int[] array4 = QS.populate(100000000);
      int[] array5 = QS.populate(100000);
      ...
      System.out.println("\nQS1 time to sort 10000 elements in ms:"+ elapsed);
      System.out.println("comparisons :"+ QS.getPartCount());

      start = System.currentTimeMillis();
      array2 = QS.qs1(array2, 0, array2.length - 1);
      end = System.currentTimeMillis();
      elapsed = end - start;
      System.out.println("\nQS1 time to sort 1000000 elements in ms:"+ elapsed);
      System.out.println("comparisons :"+ QS.getPartCount());
     
      start = System.currentTimeMillis();
      array2 = QS.qs1(array3, 0, array3.length - 1);
      end = System.currentTimeMillis();
      elapsed = end - start;
      System.out.println("\nQS1 time to sort 100000000 elements in ms:"+ elapsed);
      System.out.println("comparisons :"+ QS.getPartCount());

      start = System.currentTimeMillis();
      array3 = QS.qs1(array5, 0, array5.length - 1);
      end = System.currentTimeMillis();
      elapsed = end - start;
      ...
      start = System.currentTimeMillis();
      array3 = QS.qs1(array4, 0, array4.length - 1);
      end = System.currentTimeMillis();
      elapsed = end - start;
      System.out.println("QS1 time to sort 1000000000 elements in ms:"+ elapsed);
      System.out.println("comparisons :"+ QS.getPartCount());
